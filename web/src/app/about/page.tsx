      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg mx-auto">
          ...
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>
              <strong>Schedule delivery</strong> of prompts to fit your family's routine - 
              whether it's dinner table conversation starters or weekend activity ideas.
            </li>
            <li>
              <strong>Save your favorites</strong> to revisit activities that resonated with 
              your family.
            </li>
          </ol>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Family First:</strong> We design every feature with the goal of 
              strengthening family bonds.
            </li>
            <li>
              <strong>Privacy:</strong> We take your family's privacy seriously and never 
              share your information with third parties.
            </li>
            <li>
              <strong>Inclusivity:</strong> Our prompts are designed to be inclusive and 
              respectful of diverse family structures and backgrounds.
            </li>
            <li>
              <strong>Growth:</strong> We're constantly learning and improving our platform 
          ...
          <p>
            Ready to enhance your family conversations and activities? Sign up today and 
            discover the difference that intentional engagement can make in your family life.
          </p>
