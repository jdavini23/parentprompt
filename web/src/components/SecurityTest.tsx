...
export default function SecurityTest() {
  ...
  const handleSignIn = () => {
    router.push('/login?redirect=/security-test');
  };
    ...
    return (
      <div className="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
        ...
        <div className="mb-6 p-4 bg-yellow-100 text-yellow-700 rounded-md">
          ...
          <p className="mt-2">
            Security tests verify that Row-Level Security (RLS) policies are working correctly,
    ...
    <div className="p-6 max-w-4xl mx-auto bg-white rounded-xl shadow-md">
      ...
      <div className="mb-4 p-4 bg-green-100 text-green-700 rounded-md">
        ...
        <p className="text-sm mt-1">
          You can now run security tests to verify that Row-Level Security (RLS) policies are
          working correctly.
        </p>
      </div>
      <button
